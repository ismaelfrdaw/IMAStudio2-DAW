                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <FadeIn className="flex flex-col gap-8">
                        <div>
                            ...
                            <Heading level={1}>{t.contact.title}</Heading>
                    ...
                    <FadeIn delay={0.2} className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md p-8 sm:p-12 rounded-[2rem] shadow-2xl border border-white/20 dark:border-gray-700/30 relative overflow-hidden">
                        {status === 'success' ? (
